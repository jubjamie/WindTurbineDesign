...
opts.TolFun = 1e4; %Tolerance on the error
...
[x, diff, exitflag] = fminsearchbnd(@(x)aepCost(x,globaldata), [deg2rad(8) deg2rad(-0.5) 0], [deg2rad(2) deg2rad(-2) -0.1], [deg2rad(20) deg2rad(-0.1) 0.025], opts);
