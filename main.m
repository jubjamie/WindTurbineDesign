...
[x, diff, exitflag] = fminsearchbnd(@(x)aepCost(x,globaldata), [deg2rad(12) deg2rad(-1) 0], [deg2rad(2) deg2rad(-2) -0.1], [deg2rad(20) deg2rad(-0.1) 0.025], opts);
