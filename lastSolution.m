...
progressbar('Calculating Power', 'Solving Rotor', 'Finding Local Induced Flow', 'Parsing Solution');
        ...
        IAEP=sum(S3(:,5));
        statustablematrix([xdeg(1), xdeg(2), xdeg(3), AEP,IAEP,(IAEP-AEP),(AEP/IAEP)],{'Theta','Theta_Twist','c_grad','AEP', 'Ideal_AEP', 'Diff', 'Fraction'},'status/optSol.png','Section 3 AEP Total Solution','figure',1.2);